...
use App\Console\Commands\HttpServerCommand;
 ...
 * @codeCoverageIgnore
 */
class AppLumenSwooleServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->app->router
            ->group(['namespace' => 'App\Http\SocketIO\Controllers'], function ($router) {
                require __DIR__ . '/../routes/socket_io_routes.php';
            });
    }
