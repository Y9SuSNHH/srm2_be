...
class SoftDeletedTimeScope implements Scope
{
    /**
    ...
    public function apply(Builder $builder, Model $model)
    {
        $builder->where(function (Builder $builder) use ($model) {
            $builder->orWhereNull($model->getQualifiedDeletedAtColumn());
            $builder->orWhere($model->getQualifiedDeletedAtColumn(), 0);
        });
    }
    ...
    public function extend(Builder $builder)
    {
        ...
        $builder->onDelete(function (Builder $builder) {
            ...
            $column_by = $this->getDeletedByColumn($builder);

            return $builder->update([
                $column => time(),
                $column_by => optional(auth())->getId(),
            ]);
        });
    }
