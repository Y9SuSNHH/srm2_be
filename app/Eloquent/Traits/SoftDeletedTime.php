...
use App\Eloquent\Scopes\SoftDeletedTimeScope;
...
trait SoftDeletedTime
{
     ...
     * @return void
     */
    public static function bootSoftDeletedTime()
    {
        static::addGlobalScope(new SoftDeletedTimeScope);
    }
...
//        }
    ...
    {
        return defined(static::class.'::DELETED_AT') ? static::DELETED_AT : 'deleted_time';
    }
    ...
    {
        return defined(static::class.'::DELETED_AT') ? static::DELETED_BY : 'deleted_by';
    }
